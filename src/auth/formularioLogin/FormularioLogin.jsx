		...
		<div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-100 to-blue-200 p-4">
			...
			>
				...
				<div className="relative">
					...
					>
						{ verContrasena ?  <EyeOff size={20} className='absolute -left-5 cursor-pointer'/> : <Eye size={20}  className='absolute -left-5 cursor-pointer'/>}
					</button>
				...
				<button
					type="submit"
					className="w-full bg-blue-600 text-white py-2 rounded-xl hover:bg-blue-700 transition shadow-md"
				>
					Entrar
				</button>
			</form>
