...
import { listarReactivosVigilancia, eliminarReactivoVigilancia,exportarReactivosVigilancias } from "../../../services/reactivo_vigilancia";
...
export default function VistaDatosReactivosVigilancia() {
	...
	return (
		<div className="max-w-6xl mx-auto p-6 bg-white space-y-6">
			...
			{/* Encabezado */}
			<div>
				<h1 className="text-2xl font-bold text-gray-800">Reactivos y Vigilancia</h1>
				<p className="text-gray-600">Aquí puedes ver los datos y gestionar los reactivos.</p>
			</div>
